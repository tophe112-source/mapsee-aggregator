...
session.** The measured notes about what bites — 244 of them — live in
...
| File | Notes | Covers |
|---|---|---|
| `docs/agents/curation-and-discovery.md` | 59 | the ledger, statuses, `_not_included`, sitemaps, robots, bot challenges, site builders, plugins, deep pages, licences, the coverage report's own arithmetic |
