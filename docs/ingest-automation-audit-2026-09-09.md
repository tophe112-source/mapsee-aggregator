...
- [Tests 34359861938](https://github.com/tophe112-source/mapsee-aggregator/actions/runs/34359861938): full Linux integration gate for the final workflow, refresh and health fixes.
...
- Venue sitemap refresh had the same 120-second timeout (last successful snapshot August 30). Its existing daily cron command was repaired with the same bounded timeout. Catch-up succeeded: the public snapshot advanced to `2026-09-09T13:48:28Z`. The next scheduled run has not yet occurred.
